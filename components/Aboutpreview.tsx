...
export function AboutPreview() {
  return (
    <section className="section-padding bg-white african-overlay bg-white">
      <div className="section-container">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="aspect-[4/5] rounded-3xl bg-gradient-to-br from-primary-100 to-accent-sand overflow-hidden relative">
              {/* Placeholder for Bil Aka Kora image */}
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center p-8">
                  <div className="w-32 h-32 mx-auto mb-6 rounded-full bg-primary-500/20 flex items-center justify-center">
                    <span className="text-5xl">🎵</span>
                  </div>
                  <p className="text-neutral-500 text-sm">Photo de Bil Aka Kora</p>
                </div>
              </div>
